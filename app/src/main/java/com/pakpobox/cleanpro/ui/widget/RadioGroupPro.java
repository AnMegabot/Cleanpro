...
/**
 * 采用RadioGroup源代码改造的自定义RadioGroup，让RadioGroup内部可以添加多种布局
 * @author 唐庆文
 * @date 2014-05-16
 */
public class RadioGroupPro extends LinearLayout {
    ...
    public RadioGroupPro(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    private void init() {
    ...
    private class PassThroughHierarchyChangeListener implements
		...
		public void onChildViewAdded(View parent, View child) {
            if (parent == RadioGroupPro.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            } else if (parent == RadioGroupPro.this
